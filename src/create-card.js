...
export function createCard(title, content) {
    ...
    const project_head = document.createElement("div");
    ...
    project_head.classList.add('prj-hd');
    _title.classList.add('project-title');
    ...
    const github = `<svg class="project-card-icon" viewBox="0 0 128 128">
    ...
    project_head.append(_title)
    project_head.insertAdjacentHTML('beforeend', github);
    desc_cnt.append(project_head, desc);
