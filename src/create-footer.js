...
export default function createFooter() {
    ...
    const foot_msg = document.createElement('p');
    ...
    const photo_cnt = document.createElement('div');
    ...
    title.classList = "foot-title playfair-display-title";
    foot_msg.classList.add("footer-message");
    address.classList.add('footer-address');
    street.classList.add("street");
    state.classList.add("town-state");
    phone.classList.add("footer-phone");
    email.classList.add("footer-email");
    icon_cnt.classList.add("footer-icons");
    ...
    icon_cnt.insertAdjacentHTML('beforeend', linkedIn);
    icon_cnt.insertAdjacentHTML('beforeend', fb);

    // Append elements
    address.append(street, state, phone, email);
    contact_info.append(title, foot_msg, address, icon_cnt, photo_cnt);

    return contact_info;
}

{/* <div class="contact-info">
<h3 class="foot-title playfair-display-title">Contact me</h3>
<p class="footer-message">Please get in touch if you think our work could be mutually beneficial!</p>
<div class="footer-address">
    <p class="road">123 Random road</p>
    <p class="town-state">Rando town, Some state 2555</p>
    <p class="footer-phone">555-555-555</p>
    <p class="footer-email">yoyo@intermail.net</p>
</div>
